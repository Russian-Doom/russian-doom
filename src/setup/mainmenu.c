...
void MainMenu(void)
{
    ...
    */
    ...
    quit_action = TXT_NewWindowAction(KEY_ESCAPE, english_language ? "Quit" : "�����");
    warp_action = TXT_NewWindowAction(KEY_F2,     english_language ? "Warp" : "�������");
    lang_action = TXT_NewWindowActionY(KEY_F4,    english_language ? "�������" : "English");
