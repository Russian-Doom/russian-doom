...
void CompatibilitySettings(void)
{
    ...
    TXT_If(gamemission == doom || gamemission == heretic,   TXT_NewSeparator("ѓрафика")),
        TXT_If(gamemission == doom || gamemission == heretic,	TXT_NewCheckBox("Ѓрайтмаппинг текстур и спрайтов",           &brightmaps)),
