...
#define TXT_VERSION "VERSION 3.2.1"
#if defined (_WIN64)
#define TXT_ARCH      " - (X64)"
#elif defined (_WIN32)
#define TXT_ARCH      " - (X86)"
...
#define TXT_ARCH      ""
#endif
#define TXT_DATE      "IN DEVELOPMENT"      // YYYY-MM-DD


#define TXT_VERSION_RUS "DTHCBZ 3>2>1"      // ВЕРСИЯ 3.2.1
#if defined (_WIN64)
...
#define TXT_ARCH_RUS      ""                // ?  
#endif
#define TXT_DATE_RUS      "D HFPHF,JNRT"    // YYYY-MM-DD
