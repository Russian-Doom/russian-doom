...
state_t states[NUMSTATES] = {
    ...
    // [JN] Disable full bright for Torch, use brightmap instead
    ...
    // [JN] Disable full brightness for Crater of Might, use brightmap instead
    ...
    // [JN] Disable full brightness for Dragonskin Bracers, use brightmap instead
    ...
    // [JN] Disable full bright for Mystic Ambit Incant, use brightmap instead
    ...
    // [JN] Do not apply full brightness to the Twined Torch, use brightmap instead
    {SPR_TWTR, 0, 4, NULL, S_ZTWINEDTORCH_2, 0, 0}, // S_ZTWINEDTORCH_1
    {SPR_TWTR, 1, 4, NULL, S_ZTWINEDTORCH_3, 0, 0}, // S_ZTWINEDTORCH_2
    {SPR_TWTR, 2, 4, NULL, S_ZTWINEDTORCH_4, 0, 0}, // S_ZTWINEDTORCH_3
    {SPR_TWTR, 3, 4, NULL, S_ZTWINEDTORCH_5, 0, 0}, // S_ZTWINEDTORCH_4
    {SPR_TWTR, 4, 4, NULL, S_ZTWINEDTORCH_6, 0, 0}, // S_ZTWINEDTORCH_5
    {SPR_TWTR, 5, 4, NULL, S_ZTWINEDTORCH_7, 0, 0}, // S_ZTWINEDTORCH_6
    {SPR_TWTR, 6, 4, NULL, S_ZTWINEDTORCH_8, 0, 0}, // S_ZTWINEDTORCH_7
    {SPR_TWTR, 7, 4, NULL, S_ZTWINEDTORCH_1, 0, 0}, // S_ZTWINEDTORCH_8
    ...
    {SPR_WLTR, 2, 5, NULL, S_ZWALLTORCH4, 0, 0},    // S_ZWALLTORCH3
    {SPR_WLTR, 3, 5, NULL, S_ZWALLTORCH5, 0, 0},    // S_ZWALLTORCH4
    {SPR_WLTR, 4, 5, NULL, S_ZWALLTORCH6, 0, 0},    // S_ZWALLTORCH5
    {SPR_WLTR, 5, 5, NULL, S_ZWALLTORCH7, 0, 0},    // S_ZWALLTORCH6
    {SPR_WLTR, 6, 5, NULL, S_ZWALLTORCH8, 0, 0},    // S_ZWALLTORCH7
    {SPR_WLTR, 7, 5, NULL, S_ZWALLTORCH1, 0, 0},    // S_ZWALLTORCH8
    ...
    // [JN] Do not apply full brightness to Fire Bull, use brightmaps instead
    ...
    // [JN] Do not apply full brightness to Skull with Flame, use brightmaps instead
    {SPR_FSKL, 0, 4, NULL, S_ZFIRETHING2, 0, 0},    // S_ZFIRETHING1
    {SPR_FSKL, 1, 3, NULL, S_ZFIRETHING3, 0, 0},    // S_ZFIRETHING2
    {SPR_FSKL, 2, 4, NULL, S_ZFIRETHING4, 0, 0},    // S_ZFIRETHING3
    {SPR_FSKL, 3, 3, NULL, S_ZFIRETHING5, 0, 0},    // S_ZFIRETHING4
    {SPR_FSKL, 4, 4, NULL, S_ZFIRETHING6, 0, 0},    // S_ZFIRETHING5
    {SPR_FSKL, 5, 3, NULL, S_ZFIRETHING7, 0, 0},    // S_ZFIRETHING6
    {SPR_FSKL, 6, 4, NULL, S_ZFIRETHING8, 0, 0},    // S_ZFIRETHING7
    {SPR_FSKL, 7, 3, NULL, S_ZFIRETHING9, 0, 0},    // S_ZFIRETHING8
    {SPR_FSKL, 8, 4, NULL, S_ZFIRETHING1, 0, 0},    // S_ZFIRETHING9
    // [JN] Do not apply full brightness to Brazier with Falme, use brightmap instead
    {SPR_BRTR, 0, 4, NULL, S_ZBRASSTORCH2, 0, 0},   // S_ZBRASSTORCH1
    {SPR_BRTR, 1, 4, NULL, S_ZBRASSTORCH3, 0, 0},   // S_ZBRASSTORCH2
    {SPR_BRTR, 2, 4, NULL, S_ZBRASSTORCH4, 0, 0},   // S_ZBRASSTORCH3
    {SPR_BRTR, 3, 4, NULL, S_ZBRASSTORCH5, 0, 0},   // S_ZBRASSTORCH4
    {SPR_BRTR, 4, 4, NULL, S_ZBRASSTORCH6, 0, 0},   // S_ZBRASSTORCH5
    {SPR_BRTR, 5, 4, NULL, S_ZBRASSTORCH7, 0, 0},   // S_ZBRASSTORCH6
    {SPR_BRTR, 6, 4, NULL, S_ZBRASSTORCH8, 0, 0},   // S_ZBRASSTORCH7
    {SPR_BRTR, 7, 4, NULL, S_ZBRASSTORCH9, 0, 0},   // S_ZBRASSTORCH8
    {SPR_BRTR, 8, 4, NULL, S_ZBRASSTORCH10, 0, 0},  // S_ZBRASSTORCH9
    {SPR_BRTR, 9, 4, NULL, S_ZBRASSTORCH11, 0, 0},  // S_ZBRASSTORCH10
    {SPR_BRTR, 10, 4, NULL, S_ZBRASSTORCH12, 0, 0},  // S_ZBRASSTORCH11
    {SPR_BRTR, 11, 4, NULL, S_ZBRASSTORCH13, 0, 0},  // S_ZBRASSTORCH12
    {SPR_BRTR, 12, 4, NULL, S_ZBRASSTORCH1, 0, 0},   // S_ZBRASSTORCH13
    ...
    // [JN] Do not apply full brightness to Blue candle (lit), use brightmap instead
    {SPR_CAND, 0, 5, NULL, S_ZBLUE_CANDLE2, 0, 0},  // S_ZBLUE_CANDLE1
    {SPR_CAND, 1, 5, NULL, S_ZBLUE_CANDLE3, 0, 0},  // S_ZBLUE_CANDLE2
    {SPR_CAND, 2, 5, NULL, S_ZBLUE_CANDLE4, 0, 0},  // S_ZBLUE_CANDLE3
    {SPR_CAND, 3, 5, NULL, S_ZBLUE_CANDLE5, 0, 0},  // S_ZBLUE_CANDLE4
    {SPR_CAND, 4, 5, NULL, S_ZBLUE_CANDLE1, 0, 0},  // S_ZBLUE_CANDLE5
    ...
    // [JN] Do not apply full brightness to the Cauldron, use brightmap instead
    {SPR_CDRN, 1, 4, NULL, S_ZCAULDRON2, 0, 0},     // S_ZCAULDRON1
    {SPR_CDRN, 2, 4, NULL, S_ZCAULDRON3, 0, 0},     // S_ZCAULDRON2
    {SPR_CDRN, 3, 4, NULL, S_ZCAULDRON4, 0, 0},     // S_ZCAULDRON3
    {SPR_CDRN, 4, 4, NULL, S_ZCAULDRON5, 0, 0},     // S_ZCAULDRON4
    {SPR_CDRN, 5, 4, NULL, S_ZCAULDRON6, 0, 0},     // S_ZCAULDRON5
    {SPR_CDRN, 6, 4, NULL, S_ZCAULDRON7, 0, 0},     // S_ZCAULDRON6
    {SPR_CDRN, 7, 4, NULL, S_ZCAULDRON1, 0, 0},     // S_ZCAULDRON7
    ...
    // [JN] Do not apply full brightness to Sword's frames, use brightmaps instead
    ...
    // [JN] Disable full brightness for Mage's lightning, use brightmap instead
    ...
    {SPR_FDMN, 23, 5, NULL, S_FIRED_LOOK1, 0, 0},    // S_FIRED_SPAWN1
    {SPR_FDMN, 4, 10, A_Look, S_FIRED_LOOK2, 0, 0}, // S_FIRED_LOOK1
    {SPR_FDMN, 5, 10, A_Look, S_FIRED_LOOK3, 0, 0}, // S_FIRED_LOOK2
    {SPR_FDMN, 6, 10, A_Look, S_FIRED_LOOK1, 0, 0}, // S_FIRED_LOOK3
    {SPR_FDMN, 4, 8, NULL, S_FIRED_LOOK5, 0, 0},    // S_FIRED_LOOK4
    {SPR_FDMN, 5, 6, NULL, S_FIRED_LOOK6, 0, 0},    // S_FIRED_LOOK5
    {SPR_FDMN, 6, 5, NULL, S_FIRED_LOOK7, 0, 0},    // S_FIRED_LOOK6
    {SPR_FDMN, 5, 8, NULL, S_FIRED_LOOK8, 0, 0},    // S_FIRED_LOOK7
    {SPR_FDMN, 4, 6, NULL, S_FIRED_LOOK9, 0, 0},    // S_FIRED_LOOK8
    {SPR_FDMN, 5, 7, A_FiredRocks, S_FIRED_LOOK0, 0, 0},    // S_FIRED_LOOK9
    {SPR_FDMN, 7, 5, NULL, S_FIRED_LOOKA, 0, 0},    // S_FIRED_LOOK0
    {SPR_FDMN, 8, 5, NULL, S_FIRED_LOOKB, 0, 0},    // S_FIRED_LOOKA
    {SPR_FDMN, 9, 5, A_UnSetInvulnerable, S_FIRED_WALK1, 0, 0},     // S_FIRED_LOOKB
    {SPR_FDMN, 0, 5, A_FiredChase, S_FIRED_WALK2, 0, 0},    // S_FIRED_WALK1
    {SPR_FDMN, 1, 5, A_FiredChase, S_FIRED_WALK3, 0, 0},    // S_FIRED_WALK2
    {SPR_FDMN, 2, 5, A_FiredChase, S_FIRED_WALK1, 0, 0},    // S_FIRED_WALK3
    {SPR_FDMN, 3, 6, A_Pain, S_FIRED_WALK1, 0, 0},  // S_FIRED_PAIN1
    {SPR_FDMN, 10, 3, A_FaceTarget, S_FIRED_ATTACK2, 0, 0},  // S_FIRED_ATTACK1
    {SPR_FDMN, 10, 5, A_FiredAttack, S_FIRED_ATTACK3, 0, 0}, // S_FIRED_ATTACK2
    {SPR_FDMN, 10, 5, A_FiredAttack, S_FIRED_ATTACK4, 0, 0}, // S_FIRED_ATTACK3
    {SPR_FDMN, 10, 5, A_FiredAttack, S_FIRED_WALK1, 0, 0},   // S_FIRED_ATTACK4
    {SPR_FDMN, 3, 4, A_FaceTarget, S_FIRED_DEATH2, 0, 0},   // S_FIRED_DEATH1
    {SPR_FDMN, 11, 4, A_Scream, S_FIRED_DEATH3, 0, 0},       // S_FIRED_DEATH2
    {SPR_FDMN, 11, 4, A_NoBlocking, S_FIRED_DEATH4, 0, 0},   // S_FIRED_DEATH3
    {SPR_FDMN, 11, 200, NULL, S_NULL, 0, 0}, // S_FIRED_DEATH4
    ...
    // [JN] Do not use full brightness for Wendigo's attack frame, use brightmap instead
    {SPR_ICEY, 6, 8, A_IceGuyAttack, S_ICEGUY_ATK4, 0, 0},  // S_ICEGUY_ATK3
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
    ...
    {                           // MT_FSWORD_MISSILE
     ...
     8,                         // damage
     SFX_NONE,                  // activesound
     MF_MISSILE | MF_NOBLOCKMAP | MF_NOGRAVITY | MF_DROPOFF | MF_EXTRATRANS,    // flags
    ...
    {                           // MT_LIGHTNING_CEILING
     ...
     8,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_NOGRAVITY | MF_MISSILE | MF_DROPOFF | MF_EXTRATRANS,    // flags
     MF2_NOTELEPORT | MF2_IMPACT | MF2_PCROSS   // flags2
     },
    ...
    {                           // MT_WRAITHFX1
     ...
     5,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_NOGRAVITY | MF_DROPOFF | MF_MISSILE | MF_EXTRATRANS,    // flags
    ...
    {                           // MT_SORCFX1
     ...
     0,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_MISSILE | MF_EXTRATRANS,        // flags
     MF2_NOTELEPORT | MF2_FLOORBOUNCE   // flags2
     },
    ...
    {                           // MT_SORCFX3_EXPLOSION
     ...
     0,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_NOGRAVITY | MF_ALTSHADOW | MF_EXTRATRANS,       // flags
     MF2_NOTELEPORT             // flags2
     },
    ...
    {                           // MT_SORCFX4
     ...
     0,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_MISSILE | MF_NOGRAVITY | MF_EXTRATRANS, // flags
     MF2_NOTELEPORT             // flags2
     },
    ...
    {                           // MT_SORCSPARK1
     ...
     0,                         // damage
     SFX_NONE,                  // activesound
     MF_NOBLOCKMAP | MF_DROPOFF | MF_EXTRATRANS,        // flags
     MF2_NOTELEPORT | MF2_LOGRAV        // flags2
     },
