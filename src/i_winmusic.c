...
// Copyright(C) 2021-2026 Leonid Murin (Dasperal)
//
...
static void MidiErrorMessageBox(DWORD dwError)
{
    ...
    {
        MessageBox(NULL, szErrorBuf, english_language ?
		           "midiStream Error" : "Ошибка midiStream",
				   MB_ICONEXCLAMATION | MB_SERVICE_NOTIFICATION);
    }
    else
    {
