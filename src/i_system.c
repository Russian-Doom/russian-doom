...
//
// Описание:
// * Перевод загрузочных сообщений.
// * Информация о проекте и отказ от ответственности.
// * Номинальный объём оперативной памяти (MIN_RAM) для запуска 
//   игры увеличен вдвое и теперь равен 8 MB. Объём рабочей памяти
//   (DEFAULT_RAM) увеличен вдвое и теперь равен 32 MB.
// =--------------------------------------------------------------=
...
void I_PrintStartupBanner(char *gamedescription)
{
    ...
    printf(
    " Проект перевода основан на порте Chocolate Doom 3.0 за авторством\n"
    " Саймона Говарда (Simon Howard), и распространяется с его одобрения.\n"
