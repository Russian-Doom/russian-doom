...
//
// Описание:
// * Исправлен баг оригинальной игры, при котором бочка и потерянная 
//   душа оставляли кровавую лужу при смерти от быстрого крашера.	
//   Теперь не оставляют, кроме того, бочка более не кровоточит 
//   при получении урона от крашера.
// * Добавлены цветные ошмётки при смерти от крашера.
...
// [JN] Расширение функции по методу Фабиана Греффрата
// Это позволяет исправить баг, при котором некоторые 
// возвышения "съедали" пулевые и дробные выстрелы.
//
// PTR_ShootTraverse
//
