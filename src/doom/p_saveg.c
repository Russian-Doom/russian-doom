...
//
// Описание:
// * Исправлен оригинальный баг, при котором после загрузки игры
//   переставал мерцать свет в эффекте сектора 17.
// * Добавлена запись/загрузка общего игрового времени 
//   "totalleveltimes". Спасибо Фабиану Греффрату за помощь!
// * Исправлен оригинальный баг, при котором сохранение игры могло
//   привести к поломке (некорректной высоте) лифта или платформы.
// =--------------------------------------------------------------=
