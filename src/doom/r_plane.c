...
//
// Описание:
// * Добавлена переменная окрашивания неба в инвертированные цвета
//   при получении сферы неуязвимости (переменная invul_sky).
// * Отключен статический лимит MAXVISPLANES.
// * Отключен статический лимит MAXDRAWSEGS.
// * Скорректирован увеличеный статический лимит MAXOPENINGS.
// * Ошибка "HOM" более не будет появляться в секторе, пол и 
//   потолок которого являются небом.
// =--------------------------------------------------------------=
