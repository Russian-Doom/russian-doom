...
void M_RD_Change_ShadowIntensity(int choice);
...
menuitem_t RD_Messages_Menu[]=
{
    ...
    {2, "shadow intensity", M_RD_Change_ShadowIntensity,    't'},
    {-1,"",0,'\0'},
    {-1,"",0,'\0'},
...
menuitem_t RD_Messages_Menu_Rus[]=
{
    ...
    {2, "byntycbdyjcnm ntyb:",      M_RD_Change_ShadowIntensity, 'b'}, // Интенсивность тени
    {-1,"",0,'\0'},
    {-1,"",0,'\0'},
...
void M_RD_Draw_MessagesSettings(void)
{
    ...
    M_DrawThermo_Small(35 + wide_delta, 64, 10, shade_filter_pct / 10 - 1);

    // Numerical representation of slider position
    M_snprintf(num, 4, "%3d", shade_filter_pct);
    M_WriteTextSmall_ENG(132 + wide_delta, 65, num);
}
...
void M_RD_Change_ShadowIntensity(int choice)
{
    ...
    {
        case 0:
        if (shade_filter_pct > 10)
        shade_filter_pct -= 10;
        break;

        case 1:
        if (shade_filter_pct < 100)
        shade_filter_pct += 10;
        break;
    }
