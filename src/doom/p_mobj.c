...
//
// Описание:
// * Расширена функция P_SpawnBlood, по методу Фабиана Греффрата.
// * Добавлена цветная кровь.
// * Исправлена ошибки "Респауна (0,0)" по методу Брэда Хардинга 
//   и Джеймса "haleyjd" Хейли. 
// * Мёртвый игрок более не издаёт звук "Ууф" при падении с высоты.
// * Командир Кин будет появляться даже при параметре -nomonsters,
//   давая возможность игроку завершить уровень 32.
// =--------------------------------------------------------------=
...
void P_SpawnMapThing (mapthing_t* mthing)
{
    ...
    // [JN] Командир Кин должен быть на Map32, давая игроку
    // возможность покинуть уровень.
    if (nomonsters
    && i != MT_KEEN
	&& ( i == MT_SKULL
