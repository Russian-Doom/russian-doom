...
//
// Описание:
// * Спрайт атаки Кибердемона в момент атаки (извержения пламени) 
//   теперь будет полностью ярким.
// * Исправлен баг оригинальной игры, при котором вспышка выстрела
//   двустволки была лишней на 1 тик.
// =--------------------------------------------------------------=
