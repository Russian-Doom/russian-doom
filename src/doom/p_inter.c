...
//
// Описание:
// * Исправлен баг оригинальной игры при котором не появлялось
//   сообщение "Получена крайне необходимая аптечка!".
// * Добавлены новые сообщения к самому лёгкому и кошмарному
//   уровням сложности:
//   - Получено 8 патронов для дробовика.
//   - Получено две ракеты.
//   Спасибо Brad Harding за идею.
// * Добавлена шансовая возможность разрывать врагов выстрелом
//   в упор из двуствольного ружья. Спасибо Фабиану Греффрату.
// =--------------------------------------------------------------=
