...
//
// Описание:
// * Исправлен баг оригинальной игры, при котором быстрая дверь
//   издавала некорректный звук при повторном открытии.
//   По методу Брэда Хардинга.
// * Исправлен баг оригинальной игры, при котором нажатие на линию
//   DR, назначенное на одностороннюю линию приводило к аварийному 
//   завершению игры с ошибкой: 
//   "EV_VerticalDoor: DR special type on 1-sided linedef"
//   Ошибка более не появляется.
// * Теперь при повторном закрытии/открытии открывающейся или
//   закрывающейся двери будет воспроизводиться звук.
// =--------------------------------------------------------------=
...
void T_VerticalDoor (vldoor_t* door)
{
	...
	else if (res == crushed)
	{
		...
		break;
          ...
          // [JN] Исправление некорректного звука повторного
          // открытия быстрой двери.
