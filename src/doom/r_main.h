...
extern lighttable_t*    fullbright_cpos_attack_2[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_caco_attack_1[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_caco_attack_2[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_pain_elemental[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_lost_soul_1[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_lost_soul_2[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_bspi_attack_1[LIGHTLEVELS][MAXLIGHTSCALE];
extern lighttable_t*    fullbright_bspi_attack_2[LIGHTLEVELS][MAXLIGHTSCALE];
