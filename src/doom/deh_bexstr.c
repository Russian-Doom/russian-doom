...
static const bex_string_t bex_stringtable[] = {
    ...
    //
    // [JN] Strings for Russian translation
    //
...
//  {"SAVEGAMENAME_RUS",        SAVEGAMENAME_RUS}, [JN] Should not be translated
    // part 2 - messages when the player gets things
    ...
    {"GOTROCKET2_RUS",          GOTROCKET2_RUS}, // [JN] Получено две ракеты.
    {"GOTROCKBOX_RUS",          GOTROCKBOX_RUS},
    {"GOTCELL_RUS",             GOTCELL_RUS},
    {"GOTCELLBOX_RUS",          GOTCELLBOX_RUS},
    {"GOTSHELLS_RUS",           GOTSHELLS_RUS},
    {"GOTSHELLS8_RUS",          GOTSHELLS8_RUS}, // [JN] Получено 8 патронов для дробовика.
