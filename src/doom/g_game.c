...
{ 
    ...
    // [JN] Дополнительный фидбек о загрузке игры
...
void G_DoPlayDemo (void)
{
    ...
    else if (demoversion != G_VanillaVersionCode())
    {
        char *message = "Демозапись от другой версии игры!\n"
                        ...
                        "\n"
                        "*** Вам необходимо обновить вашу версию "
                            "Doom до v1.9. ***\n"
                        "    Дополнительная информация: https://www.doomworld.com/classicdoom"
                                  "/info/patches.php\n";
...
{ 
	...
	I_Error ("насчитано %i gametics в %i realtics (%f fps)",
