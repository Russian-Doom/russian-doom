...
//
// Описание:
// * Добавлено опциональное оповещение о найденом секрете.
//   По методу Fabian Greffrath.
// * Увеличен статический лимит MAXLINEANIMS: 64 * 256 = 16384
// * Отключен статический лимит MAXANIMS.
// * Отключен статический лимит MAX_ADJOINING_SECTORS.
// =--------------------------------------------------------------=
