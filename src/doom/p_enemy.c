...
//
// Описание:
// * Добавлена переменная снятия лимита с атаки Pain Elemental:
//   "unlimited_lost_souls", увеличивающая лимит с 20 до 10240.
// * Исправлени баг оригинальной игры с отсутствующим параметром
//   A_FaceTarget у Барона и Рыцаря Ада.
// * Исправлен баг оригинальной игры с некорректными координатами
//   появления пламени Арчвайла.
// * Исправлен довольно критичный баг оригинальной игры с Иконой
//   Греха, который мог вызвать аварийное завершение игры при
//   сохранении и загрузке игры на 30м уровне.
//   Огромное спасибо Фабиану Греффрату!
// =--------------------------------------------------------------=
  ...
  angle_t	angle )
{
	...
	if (unlimited_lost_souls && !demorecording && !netgame && !demoplayback)
	{
		if (count > 10240)
		return;
	}
