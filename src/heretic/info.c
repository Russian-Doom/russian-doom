...
// Definitions for action pointer functions.
void A_FreeTargMobj();
...
state_t states[NUMSTATES] = {
    ...
    // [JN] Disable full bright, use brightmaps instead
    {SPR_WTRH, 0, 6, NULL, S_WALLTORCH2, 0, 0},     // S_WALLTORCH1
    {SPR_WTRH, 1, 6, NULL, S_WALLTORCH3, 0, 0},     // S_WALLTORCH2
    {SPR_WTRH, 2, 6, NULL, S_WALLTORCH1, 0, 0},     // S_WALLTORCH3
