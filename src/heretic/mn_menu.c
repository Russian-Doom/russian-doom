...
static void DrawGamepadMenu_1()
{
    ...
    if(english_language)
    {
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  263 + wide_delta, 62,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  210 + wide_delta, 82,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);


        RD_M_DrawTextSmallENG(currentController ? (GetAxisNameENG(currentController->bindAxis[SDL_CONTROLLER_AXIS_LEFTY])) : "N/A",
                              100 + wide_delta, 112, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  263 + wide_delta, 122,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  210 + wide_delta, 142,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
    }
    else
    {
        ...
        RD_M_DrawTextSmallRUS(currentController ? (GetAxisNameRUS(currentController->bindAxis[SDL_CONTROLLER_AXIS_LEFTX])) : "Y/F",
                              105 + wide_delta, 52, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);

        RD_Menu_DrawSliderSmallInline(145, 62, 16,
                                      currentController ? currentController->axisSensitivity[SDL_CONTROLLER_AXIS_LEFTX] - 1 : 0);
        if(currentController)
            M_snprintf(num, 6, "%2d", currentController->axisSensitivity[SDL_CONTROLLER_AXIS_LEFTX]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  293 + wide_delta, 62,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        if(currentController)
            M_snprintf(num, 6, "%3d%%", currentController->axisDeadZone[SDL_CONTROLLER_AXIS_LEFTX]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  217 + wide_delta, 82,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);


        RD_M_DrawTextSmallRUS(currentController ? (GetAxisNameRUS(currentController->bindAxis[SDL_CONTROLLER_AXIS_LEFTY])) : "Y/F",
                              105 + wide_delta, 112, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);

        RD_Menu_DrawSliderSmallInline(145, 122, 16,
                                      currentController ? currentController->axisSensitivity[SDL_CONTROLLER_AXIS_LEFTY] - 1 : 0);
        if(currentController)
            M_snprintf(num, 6, "%2d", currentController->axisSensitivity[SDL_CONTROLLER_AXIS_LEFTY]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  293 + wide_delta, 122,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        if(currentController)
            M_snprintf(num, 6, "%3d%%", currentController->axisDeadZone[SDL_CONTROLLER_AXIS_LEFTY]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  217 + wide_delta, 142,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
    }
}
...
static void DrawGamepadMenu_2()
{
    ...
    if(english_language)
    {
        RD_M_DrawTextSmallENG(currentController ? (GetAxisNameENG(currentController->bindAxis[SDL_CONTROLLER_AXIS_RIGHTX])) : "N/A",
                              100 + wide_delta, 42, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  263 + wide_delta, 52,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  210 + wide_delta, 72,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);


        RD_M_DrawTextSmallENG(currentController ? (GetAxisNameENG(currentController->bindAxis[SDL_CONTROLLER_AXIS_RIGHTY])) : "N/A",
                              100 + wide_delta, 102, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  263 + wide_delta, 112,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        RD_M_DrawTextSmallENG(currentController ? num : "N/A",  210 + wide_delta, 132,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
    }
    else
    {
        RD_M_DrawTextSmallRUS(currentController ? (GetAxisNameRUS(currentController->bindAxis[SDL_CONTROLLER_AXIS_RIGHTX])) : "Y/F",
                              105 + wide_delta, 42, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);

        RD_Menu_DrawSliderSmallInline(145, 52, 16,
                                      currentController ? currentController->axisSensitivity[SDL_CONTROLLER_AXIS_RIGHTX] - 1 : 0);
        if(currentController)
            M_snprintf(num, 6, "%2d", currentController->axisSensitivity[SDL_CONTROLLER_AXIS_RIGHTX]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  293 + wide_delta, 52,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        if(currentController)
            M_snprintf(num, 6, "%3d%%", currentController->axisDeadZone[SDL_CONTROLLER_AXIS_RIGHTX]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  217 + wide_delta, 72,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);


        RD_M_DrawTextSmallRUS(currentController ? (GetAxisNameRUS(currentController->bindAxis[SDL_CONTROLLER_AXIS_RIGHTY])) : "Y/F",
                              105 + wide_delta, 102, currentController ? CR_NONE : CR_WHITE2DARKRED_HERETIC);

        RD_Menu_DrawSliderSmallInline(145, 112, 16,
                                      currentController ? currentController->axisSensitivity[SDL_CONTROLLER_AXIS_RIGHTY] - 1 : 0);
        if(currentController)
            M_snprintf(num, 6, "%2d", currentController->axisSensitivity[SDL_CONTROLLER_AXIS_RIGHTY]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  293 + wide_delta, 112,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
        ...
        if(currentController)
            M_snprintf(num, 6, "%3d%%", currentController->axisDeadZone[SDL_CONTROLLER_AXIS_RIGHTY]);
        RD_M_DrawTextSmallRUS(currentController ? num : "Y/F",  217 + wide_delta, 132,currentController ? CR_WHITE2GRAY_HERETIC : CR_WHITE2DARKRED_HERETIC);
    }
}
