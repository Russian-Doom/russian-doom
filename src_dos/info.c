...
state_t	states[NUMSTATES] = {
    ...
    // [JN] Firing frame of Zombieman should be in full brightness
    ...
    // [JN] Some frames of Mastermind's death should be in full brightness
    ...
    // [crispy] and [JN] Cyberdemon's firing frames should be in full brightness
    ...
    // [JN] Some frames of Cyberdemon's death should be in full brightness
