...
vcpkg install --triplet=x86-windows sdl2 sdl2-mixer[core,nativemidi,libmodplug,opusfile] sdl2-net libsamplerate
vcpkg install --triplet=x64-windows sdl2 sdl2-mixer[core,nativemidi,libmodplug,opusfile] sdl2-net libsamplerate
```
